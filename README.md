# Chronosophy — The Philosopher's Axiom  ·  v9
...
quotes        (id, philosopher_id FK, text, is_favourite)  -- v9: is_favourite added

daily_quote   (id=1, quote_id, selected_on)                -- singleton row

teacher_links (id, student_id FK, teacher_id FK)           -- v9: parsed from teachers field
```
